...
<html lang="en">
<head>
    <title>Code coverage report for lib/services/scssCompletion.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/services/</a> scssCompletion.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var __extends = (this &amp;&amp; this.__extends) || (function () {
...
(function (factory) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof module === "object" &amp;&amp; typeof module.exports === "object") {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (v !== undefined) <span class="cstat-no" title="statement not covered" >module.exports = v;</span>
    }
    else <span class="cstat-no" title="statement not covered" >if (typeof define === "function" &amp;&amp; define.amd) {</span>
<span class="cstat-no" title="statement not covered" >        define(["require", "exports", "./cssCompletion", "vscode-languageserver-types", "vscode-nls"], factory);</span>
    }
...
//# sourceMappingURL=scssCompletion.js.map</pre></td></tr>
</table></pre>
